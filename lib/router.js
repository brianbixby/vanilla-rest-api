...
// route method, router.route will return a method with a req and res we run in through promise.all meaning that the url got parsed and the body was parsed; router.route returns a method with a request and a response
